...
const create_vacations = "CREATE TABLE IF NOT EXISTS vacations (id INT NOT NULL AUTO_INCREMENT,description VARCHAR(250) NULL,destination VARCHAR(45) NULL,image LONGTEXT,start_date DATE NULL,end_date DATE NULL,price INT NULL,followers_count INT NULL,PRIMARY KEY (id))";
